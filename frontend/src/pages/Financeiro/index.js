...
const Invoice = ({ invoice, onPayClick }) => {
  const handlePayClick = () => {
    // Aquí puede abrir el enlace de la factura según "invoice.detail"
    // Asegúrese de que "invoice.detail" contenga la URL de factura correcta.
    // Ejemplo:
  ...
  return (
    <TableRow key={invoice.id}>
      ...
      </TableCell> {/* Agregue esta columna para la fecha de vencimiento */}
      <TableCell align="center">
        {invoice.value ? invoice.value.toLocaleString("es", {
          style: "currency",
          currency: "USD",
        }) : 'N/A'}
      </TableCell>
