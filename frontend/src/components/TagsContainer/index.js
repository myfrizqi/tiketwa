...
export function TagsContainer({ contact }) {
    ...
    function getRandomHexColor() {
        // Generar valores aleatorios para componentes de color.
        const red = Math.floor(Math.random() * 256); // Valor entre 0 y 255
        const green = Math.floor(Math.random() * 256); // Valor entre 0 y 255
        const blue = Math.floor(Math.random() * 256); // Valor entre 0 y 255
