                ...
                <CardHeader
                  ...
                  title={(
                    <span>{group?.user?.name || "Pendentes"} <br />
                      {`Chats: ${group.userTickets?.length}`}
                    </span>
                  )}
                />
              </Paper>
                      ...
                      <ListItemText
                        ...
                        secondary={
                          <Fragment>
                            ...
                            <Badge style={{ backgroundColor: ticket.queue?.color || "#7c7c7c" }} className={classes.connectionTag}>{ticket.queue?.name.toUpperCase() || "SIN DEPARTAMENTOS"}</Badge>
                          </Fragment>
                        }
                      />
                      <Typography
