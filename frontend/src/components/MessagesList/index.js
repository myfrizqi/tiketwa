...
const formatXml = (xmlString) => {
  // Comprueba si el XML contiene la firma con el nombre del asistente.
  if (boldRegex.test(xmlString)) {
    // Formatea el texto dentro de la firma en negrita.
        ...
        return (
          <React.Fragment key={message.id}>
            ...
            >
              ...
              {/* mensaje mensaje eliminado por contacto */}
