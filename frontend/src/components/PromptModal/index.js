...
const PromptSchema = Yup.object().shape({
    ...
    prompt: Yup.string().min(50, "¡Demasiado corto!").required("Describir el entrenamiento y comportamiento de la Inteligencia Artificial"),
    ...
    apikey: Yup.string().required("Ingrese la API Key"),
